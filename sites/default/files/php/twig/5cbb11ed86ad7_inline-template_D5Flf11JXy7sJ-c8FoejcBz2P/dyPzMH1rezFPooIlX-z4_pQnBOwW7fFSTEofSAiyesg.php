...
{{enrolledstudents}}
{% if user_test.name.value in enrolledstudents|keys %}
     {{ 'Enrolled Already' }}
{% else %}
 ...
 */
class __TwigTemplate_8cc3c4dbe112563f5848a0677d5e647966ad0949dab0911322b8bb808619e796 extends \Twig\Template
{
...
";
        // line 4
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["enrolledstudents"] ?? null)), "html", null, true);
        echo "
";
        // line 5
        if (twig_in_filter($this->getAttribute($this->getAttribute(($context["user_test"] ?? null), "name", []), "value", []), twig_get_array_keys_filter(($context["enrolledstudents"] ?? null)))) {
            // line 6
            echo "     ";
