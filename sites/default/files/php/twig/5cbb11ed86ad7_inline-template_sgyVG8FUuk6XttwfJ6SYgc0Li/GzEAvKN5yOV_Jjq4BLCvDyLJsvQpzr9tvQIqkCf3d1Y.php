...
{% if (user_test.uid.value in enrolledstudents|keys) %}
     {{ 'Enrolled Already' }}
{% else %}
 ...
 */
class __TwigTemplate_f3bedb4fb31b0bd4a42a9b3ba5cf69f6fd6a6f3cb2d4d96ee39db6a5447bd0de extends \Twig\Template
{
...
";
        // line 5
        if (twig_in_filter($this->getAttribute($this->getAttribute(($context["user_test"] ?? null), "uid", []), "value", []), twig_get_array_keys_filter(($context["enrolledstudents"] ?? null)))) {
            // line 6
            echo "     ";
